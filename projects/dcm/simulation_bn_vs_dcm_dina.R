...
# no_struct <- cmdstan_model(here::here("projects/bn_vs_dina/final_DINA_bn_no_structure.stan"))
# independent <- cmdstan_model(here::here("projects/bn_vs_dina/final_DINA_bn_ind_structure.stan"))
linear <- cmdstan_model(here::here("projects/bn_vs_dina/final_DINA_bn_linear_structure.stan"))

set.seed(12345)
fit <- linear$sample(
# fit <- independent$sample(
# fit <- no_struct$sample(
  data = stan_list,
  seed = 12345,
  chains = 4,
  # init = 0,
  ...
  iter_sampling = 2000,
  adapt_delta = .99,
  parallel_chains = parallel::detectCores() - 110
)

# saveRDS(fit, here::here("projects/bn_vs_dina/no_structure_dina_bn.RDS"))
# saveRDS(fit, here::here("projects/bn_vs_dina/ind_structure_dina_bn.RDS"))
# saveRDS(fit, here::here("projects/bn_vs_dina/linear_structure_dina_bn.RDS"))
